  ...
  return (
    <Page>
      ...
      <motion.main layout className='h-screen pt-20 md:px-10 lg:px-20 pb-10 flex flex-col gap-10 justify-start md:justify-center items-center bg-dark-blue text-white' >
        ...
        >
          ...
          <motion.div>
            ...
            <motion.p {...textAnimate}>
              Aquatec has constructed quality swimming pools for homes and institutions in Ghana since 1976. Additionally, Aquatec is a water industry leader with its products and services for industrial and residential water supply.
            </motion.p>
        ...
        <motion.div className='w-full h-30vh md:h-50vh relative rounded-tr-[15vw] rounded-tl-[15vw] overflow-hidden' {...textAnimate} >
